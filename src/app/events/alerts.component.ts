...
import { CheerData, EventQueueData, FollowData, GiftBombData, GiftSubData, MessageData, RaidData, StreamerBotMessage, SubData } from 'src/app/models/alerts.model';
...
export class AlertsComponent implements OnInit {
  ...
  eventBusy = true;
  eventData: MessageData | SubData | GiftSubData | RaidData | GiftBombData | FollowData | CheerData | any;
